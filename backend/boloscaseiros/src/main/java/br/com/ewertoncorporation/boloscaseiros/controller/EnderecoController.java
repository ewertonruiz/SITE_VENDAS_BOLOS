...
import br.com.ewertoncorporation.boloscaseiros.service.EnderecoService;
...
public class EnderecoController implements ICrudController<Endereco>{
   ...
   @Autowired
    ...
    public ResponseEntity<List<Endereco>> getAll() {
        List<Endereco> registro = service.getAll();
    ...
    public ResponseEntity<Endereco> getById(@PathVariable("id") Long id) {
        Endereco registro = service.getById(id);
        return new ResponseEntity<>(registro, HttpStatus.OK);
    }

    @Override
    @GetMapping("/busca/{termoBusca}")
    public ResponseEntity<List<Endereco>> getByAll(@PathVariable("termoBusca") String termoBusca) {
        List<Endereco> registro = service.getByAll(termoBusca);
        return new ResponseEntity<>(registro, HttpStatus.OK);
    }
    ...
    public ResponseEntity<Endereco> insert(@RequestBody Endereco objeto) {
        Endereco registro = service.save(objeto);
       return new ResponseEntity<>(registro, HttpStatus.OK);
    }
